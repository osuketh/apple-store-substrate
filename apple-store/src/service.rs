...
use apple_store_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	apple_store_runtime::api::dispatch,
	apple_store_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/apple_store_runtime.compact.wasm")
);
